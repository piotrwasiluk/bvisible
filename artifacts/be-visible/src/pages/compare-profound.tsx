...
const features = [
  {
    feature: "AI Engines",
    bvisible: "5 (ChatGPT, Gemini, Perplexity, Claude, Google AI Mode)",
    competitor: "ChatGPT only (starter), 3 on Growth",
  },
  {
    feature: "Starting Price",
    bvisible: "Free audit / Pro from $79/mo",
    competitor: "From $99/mo",
  },
  {
    feature: "Team Seats",
    bvisible: "Unlimited",
    competitor: "1 (starter), 3 (growth)",
  },
  {
    feature: "Content Generation",
    bvisible: "No (focused on analytics)",
    competitor: "Yes (6 articles/mo on Growth)",
  },
  {
    feature: "Regional Coverage",
    bvisible: "Global",
    competitor: "1 region (starter)",
  },
  {
    feature: "Prompt Generation",
    bvisible: "AI-powered auto-generation",
    competitor: "Manual",
  },
  {
        ...
        >
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg md:text-xl text-neutral-500 max-w-2xl mx-auto leading-relaxed">
              Profound blends AI visibility analytics with content generation.
              Here is how the two platforms compare on the analytics side.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#F9F9FA]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                ...
                <ul className="space-y-3 text-neutral-600">
                  <li className="flex items-start gap-3">
                    ...
                    More AI engines covered (5 vs 1-3)
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
                    Lower starting price at $79/mo
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
              ...
              <div>
                <h3 className="text-xl font-bold mb-4">Profound strengths</h3>
                <ul className="space-y-3 text-neutral-600">
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="rounded-2xl border border-[#E2E2E3] p-8 bg-white">
                ...
                <ul className="space-y-2 text-neutral-600 text-sm">
                  <li>You want the broadest AI engine coverage</li>
                  <li>Your team has more than 3 members</li>
                  <li>You need data exports on every plan</li>
                  <li>You want to try before you buy with a free audit</li>
                  <li>
                    You already have a content workflow and need pure analytics
                  </li>
                </ul>
              </div>
              <div className="rounded-2xl border border-[#E2E2E3] p-8 bg-white">
                ...
                <ul className="space-y-2 text-neutral-600 text-sm">
                  <li>You need AI content generation alongside analytics</li>
                  <li>You publish through WordPress</li>
                  <li>SOC 2 compliance is a hard requirement</li>
                  <li>You only need to monitor 1-3 AI engines</li>
                </ul>
              </div>
            </div>
          </div>
