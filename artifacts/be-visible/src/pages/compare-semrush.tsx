...
const features = [
  {
    feature: "AI Engines",
    bvisible: "5 dedicated engines",
    competitor: "Google AI Mode + ChatGPT",
  },
  {
    feature: "Geographic Coverage",
    bvisible: "Global (all regions)",
    competitor: "6 regions",
  },
  {
    feature: "Team Members",
    bvisible: "Unlimited (free)",
    competitor: "$45/month per user",
  },
  {
    feature: "Citation Analysis",
    bvisible: "Domain + URL level",
    competitor: "Own pages only",
  },
  { feature: "Cross-Engine Comparison", bvisible: true, competitor: false },
  {
    feature: "Data Export",
    bvisible: "All plans",
    competitor: "Not yet available",
  },
  {
    feature: "Custom Prompts",
    bvisible: "AI-generated + manual",
    competitor: "Manual only",
  },
  { feature: "Daily Updates", bvisible: true, competitor: true },
  {
    feature: "Starting Price",
    bvisible: "Free audit / Pro from $79/mo",
    competitor: "$99/mo (requires Semrush subscription)",
  },
];
        ...
        >
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg md:text-xl text-neutral-500 max-w-2xl mx-auto leading-relaxed">
              Semrush added AI search tracking to its SEO suite. Here is how its
              AI Toolkit compares to a purpose-built AI visibility platform.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#F9F9FA]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                ...
                <ul className="space-y-3 text-neutral-600">
                  <li className="flex items-start gap-3">
                    ...
                    5 AI engines in a unified dashboard
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
                    Global coverage with no region limits
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
                    Unlimited team seats at no extra cost
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
                    Free audit with no credit card
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
              ...
              <div>
                <h3 className="text-xl font-bold mb-4">Semrush strengths</h3>
                <ul className="space-y-3 text-neutral-600">
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
                    239M prompt index for research
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
                    Integrated SEO platform (keywords, backlinks, etc.)
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-600 mt-0.5 shrink-0" />{" "}
                    Established ecosystem and third-party integrations
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="rounded-2xl border border-[#E2E2E3] p-8 bg-white">
                ...
                <ul className="space-y-2 text-neutral-600 text-sm">
                  <li>
                    You want dedicated AI visibility analytics, not an add-on
                  </li>
                  <li>
                    You need to compare visibility across 5 engines at once
                  </li>
                  <li>Your team is larger than one and you want free seats</li>
                  <li>You need global coverage without region restrictions</li>
                  <li>You want to start with a free audit before committing</li>
                </ul>
              </div>
              <div className="rounded-2xl border border-[#E2E2E3] p-8 bg-white">
                <h3 className="text-lg font-bold mb-4">Choose Semrush if...</h3>
                <ul className="space-y-2 text-neutral-600 text-sm">
                  <li>
                    You already pay for Semrush and want AI data in one place
                  </li>
                  <li>You need access to a massive prompt research index</li>
                  <li>Traditional SEO tools are still your primary workflow</li>
                  <li>You only need Google AI Mode and ChatGPT tracking</li>
                </ul>
              </div>
            </div>
          </div>
